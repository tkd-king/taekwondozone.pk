...
import { CreateUniformObject, deleteUniform, findOneUniform, getAllUniforms, lowercaseAllFields, soldUniforms, updatedUniform } from "../controller/uniform.controller.js";
...
router.route('/allupdatestostring').put( lowercaseAllFields );
